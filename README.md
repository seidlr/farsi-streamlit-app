...
Streamlit App to explore Farsi pronuncaiation

Built with ❤️ by [seidlr](https://github.com/seidlr)
...
git clone git@github.com:seidlr/farsi-streamlit-app.git

# Go to correct directory
cd farsi-streamlit-app
